            ...
            <Dialog open={!!deleteTarget} onOpenChange={(v) => !v && setDeleteTarget(null)}>
                <DialogContent className="sm:max-w-sm">
                    ...
                    <DialogFooter>
                        ...
                        <Button variant="destructive" onClick={() => deleteTarget && deleteAlmox.mutate(deleteTarget.id, { onSuccess: () => setDeleteTarget(null) })} loading={deleteAlmox.isPending}>Excluir</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
